...
|--------|------------|--------------------|
| `mart_route_analysis` | Анализ маршрутов | Выявление самых популярных направлений и средних цен |
| `mart_airline_performance` | Производительность авиакомпаний | Сравнение количества рейсов, средней цены, доли прямых рейсов |
| `mart_temporal_patterns` | Временные паттерны | Анализ динамики цен по дням недели и сезонности |
| `mart_flight_type_analysis` | Типы перелётов | Распределение прямых/транзитных рейсов и их стоимости |
| `mart_price_summary` | Сводка по ценам | Ключевые метрики за текущий месяц (доход, средняя цена и т.д.) |
...
DAG зависит от завершения DDS-процессов через `ExternalTaskSensor` - гарантируется актуальность данных.
...
- **Самые популярные маршруты**: Москва -> Сочи (16 рейсов), Москва -> Тбилиси (12 рейсов), Москва -> Краснодар (11 рейсов)
- **Лидеры среди авиакомпаний**: Pobeda (26 рейсов), Aeroflot (18 рейсов)
- **64% всех рейсов - прямые**, при этом средняя цена прямого рейса - **7 483 рубля**
- **Самые дорогие направления**: Тбилиси (средняя цена 18 466 руб.), Стамбул (15 320 руб.)
- **Пик цен** по средам и субботам

**Рекомендации**:
- Пользователям: выбирать прямые рейсы авиакомпании Pobeda для экономии
- Бизнесу: запускать маркетинговые кампании в будние дни, когда цены ниже
